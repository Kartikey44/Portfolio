...
function Work() {
  return (
    <div id="services" className='max-w-screen scroll-mt-32  px-5 text-center '>
    ...
    <div className='grid grid-cols-1 max-w-7xl py-6 gap-10 md:grid-cols-3 mx-auto'>
        {work.map((work, name) => (<div key={name} className='bg-gray-800/40 flex flex-col gap-2 rounded-xl shadow-xl text-left px-4 pt-4 pb-6'>
